...
- **🤖 Intelligent LLM-powered recommendations**: Uses advanced LLMs (Gemini/GPT) to understand semantic relevance and provide personalized paper recommendations.
- **📊 Detailed scoring and reasoning**: Each recommended paper comes with a relevance score (1-10) and detailed explanation for why it was recommended.
...
- **🎯 Configurable research interests**: Customize your research areas through YAML configuration files.
- **⚡ Advanced filtering**: Support for both category-based and keyword-based paper discovery.
...
![LLM Recommender Algorithm](./assets/LLM_recommender_algorithm_diagram.png)

The advanced LLM recommendation system uses large language models (Gemini/GPT) to provide intelligent, context-aware paper recommendations

For detailed configuration and usage, see [LLM Recommender Documentation](./README_LLM_RECOMMENDER.md).
...
## 📌 Limitations
- The recommendation algorithm is still somewhat simple, it may not accurately reflect your interest. Welcome better ideas for improving the algorithm!
...
## TODO -- by Zining Wang
- Make full use of the in context ability of LLM by providing example papers with scores (Apple's paper - 10, pi0.5 - 10, some relavant but bad paper - 4)
